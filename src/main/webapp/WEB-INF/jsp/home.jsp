      ...
      <div class="row">
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              <p class="card-text">Streamline your business processes and zoom ahead of the competition with SRS Business Consulting Services. From Business Analytics to Program Management to ERP, we deliver solutions with unmatched value.</p>
            </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              <p class="card-text">Stay ahead of the curve in a rapidly changing market dynamic with SRS Application Consulting Services. Deep technology expertise, Best-in-class processes and Constant innovation are the hallmark of our Application Consulting Services.</p>
            </div>
            <div class="card-footer">
              <a href="#" class="btn btn-primary">Learn More</a>
            </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              <p class="card-text">Achieve strategic alignment between your business objectives and your HR Strategy with SRS Human Capital Consulting Services. Our global footprint and access to a wide pool of experts with cross spectrum skills enable us to redefine excellence.</p>
            </div>
            <div class="card-footer">
              <a href="#" class="btn btn-primary">Learn More</a>
            </div>
